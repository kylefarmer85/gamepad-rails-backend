class Api::V1::GamesController < ApplicationController
  ...
  def top_rated_by_console
    console = params[:console_id]
    key =  key = ENV["RAWG_API_KEY"]
      
    url = "https://rawg.io/api/games?ordering=-rating&platforms=#{console_id}&page_size=10"
    ...
    top_rated_by_console_results = JSON.parse(response)
    render json: top_rated_by_console_results
  end
